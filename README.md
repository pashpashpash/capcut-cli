...
cargo run -- library sound judge --top 3 --platform tiktok --require-reason "downloaded candidate" --min-score 75 --min-reason-count 5 --max-trend-rank 25
cargo run -- update --bin-path "$HOME/.local/bin/capcut-cli"
